    ...
    <body class="darkMode">
      <div class="container">
        ...
        if (isset($_POST["otherId"])) {
          ...
          $query3 = "SELECT * FROM tbalbumcontent WHERE user_id = '$user' AND album_id = '$id'";
          ...
          $row3 = mysqli_fetch_array($res3);
            ...
            echo "<div class = 'card'>";
              ...
              <ul class='nav nav-tabs card-header-tabs'>
                <li class='nav-item'>
                  <a class='nav-link active' id='useless' href=''>" . $row3["albumName"] . "</a>
                </li>
                <li class='nav-item'>
                  <a class='nav-link' id='useless' >Description: " . $row3["albumDescription"] . "</a>
                </li>
                <li class='nav-item'>
                  <a class='nav-link' id='useless' >Hashtags: " . $row3["albumHashtags"] . "</a>
                </li>
              </ul>
              </div>";
              ...
              $query4 = "SELECT * FROM tbgallery WHERE image_id = '$imageId'";
              ...
              echo "<div class='card-body'>";
                echo "<div class = 'row imageGallery' id = 'imageGallery'>";
                    ...
                    echo 	"
                      <div class = 'col-3 profBut mt-2' style = 'background-image: url(" . $row4['filename'] ."); background-repeat: no-repeat; background-size: 80% 80%;'>
                        <input type='hidden' name='pt' id='pt' value = '" . $row4["image_id"] . "'/>
                      </div>
                    ";
                    ...
                    while($row3 = mysqli_fetch_array($res3)) {
                      ...
                      $row4 = mysqli_fetch_array($res4);
                        ...
                        echo 	"
                          <div class = 'col-3 profBut mt-2' style = 'background-image: url(" . $row4['filename'] ."); background-repeat: no-repeat;'>
                            <input type='hidden' name='pt' id='pt' value = '" . $row4["image_id"] . "'/>
                          </div>
                        ";
                      }
