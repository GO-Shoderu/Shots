    ...
    <body class="darkMode">
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
                ...
                Post
                    ...
                    <div class="col-12 col-lg-6">
                      <div class="row">
                        ...
                        <div class="col-12 col-lg-6 form-group">
                          <label for="formControlSelect">Albums:</label>
                          <select class="form-control custom-select text-center" id="formControlSelect" name="formControlSelect">
                            <option value="Upload as is" selected>----------</option>
                            <option value="Create Album">Create Album</option>

                            <?php

                              //options dev comes here
                              $user = $_SESSION['user'];
                              $albums = array();

                              $queryAlbum = "SELECT * FROM tbalbumcontent WHERE user_id = '$user'";
              					      $resAlbum = $mysqli->query($queryAlbum);

                              while($rowAlbum = mysqli_fetch_array($resAlbum)) {

                                if (in_array($rowAlbum["albumName"], $albums)) {
                                  // code...
                                  //do nothing
                                }else {
                                  // code...
                                  $albums[] = $rowAlbum["albumName"];
                                }
                              ...
                              while ($a < count($albums)) {
                                // code...
                                echo '<option value="' . $albums[$a] . '">' . $albums[$a] . '</option>';
                                $a++;
                              }
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-12 col-lg-6 text-center adjust">
  										<button type="submit" class="btn btn-dark picToUpload" name='submit'>Upload Image </button>
  									</div>
                  </div>
  							</div>
  						</form>
          ...
          <!-- <div class="col-sm-4 col-12 text-center friend-suggesting ">
            <p> Profile image, friends suggestion area </p>
          </div> -->
        ...
        <!-- <div class="row align-items-center"> -->
                              ...
                              echo "<div class=' col-1'><img src='" . $noProfile . "' width='38' height='38' class='d-inline-block align-top' alt='' /></div>";
                                    ...
                                    if ($user == $row3["user_id"]) {
                                      ...
                                      echo "<form method='POST' action='remove.php'>
                                        <input type='hidden' name='pt' id='pt' value = '" . $row3["image_id"] . "'/>
                                        <input type='submit' class='dropdown-item' style='color: red;' value = 'Delete post' />
                                      </form>";
                                    }else {
                                      // code...
                                      echo "
                                          <div class='mt-3 col-2'><h6><a href='' class='otherProfile'>" . $row4['name'] . "</a></h6></div>
                                            ...
                                            <div class='mt-1 dropdown text-center col-1 offset-8'>
                                                <a class='navbar-brand navProfile dropdown-toggle' data-toggle='dropdown' href='#'></a>
                                                <div class='dropdown-menu text-center'>";
                                      echo "<a href='' class='dropdown-item unfollowHome' style='color: red;'>Unfollow</a>
                                            <input type='hidden' name='otherId' id='otherId' value = '" . $row4["user_id"] . "'/>
                                            <input type='hidden' name='otherId' id='ownId' value = '" . $_SESSION['user'] . "'/>
          ...
          <!-- <div class="col-sm-4 col-12 text-center friend-suggesting ">
            <p> Profile image, name & Friends online area </p>
          </div> -->
