          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item  active">
                <a class="nav-link" href="#">Add Album <span class="sr-only">(current)</span></a>
              </li>
            </ul>
          ...
          $res3 = $mysqli->query($query3);
            ...
            echo "<div class = 'card'>";
              ...
              <ul class='nav nav-tabs card-header-tabs'>
                <li class='nav-item'>
                  <a class='nav-link active' id='' href=''>+ Add Album</a>
                </li>
              </ul>
              </div>";
              // echo "<div class='card-body'>";
                ...
                echo '<form method="POST" action="albumCreator.php"  enctype="multipart/form-data">
                  <div class="card-body">

                  <h5 class="card-title"><b>Album</b></h5>
                  ...
                  <div class="col-12 col-lg-6">
                    <div class="row">
                      ...
                      <div class="col-12 col-lg-6">
                        <label for="albumHash">Hashtags:</label>
                        <textarea class="form-control" id="albumHash" name="albumHash" rows="1"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-lg-6">
                    <label for="albumDesc">Description:</label>
                    <textarea class="form-control" id="albumDesc" name="albumDesc" rows="1"></textarea>
                  </div>
                </div>

                <br/>
                <h5 class="card-title"><b>Image</b></h5>
                ...
                <div class="row mt-3">
                  <div class="col-12 col-lg-6 input-group-prepend">
                    ...
                    echo ' <div class="col-12 col-lg-6 text-center adjust">
                    <button type="submit" class="btn btn-dark" name="submit">Create Album & Upload Image </button>
                  </div>
                </div>
              </div>
            </form>
