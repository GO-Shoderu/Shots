      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <b><h5 class="card-title">Reason for Reporting</h5></b>
              <br/>
              <form method="POST" action="addReport.php" class="text-center">
                <div class="form-group">
                  <label for="reportOption">Select below: </label>
                  <select class="form-control" id="reportOption" name="reportOption">

                    <?php
                      $query = "SELECT * FROM tbreasons";
                ...
                <?php
                  ...
                  echo "
                  <input type='hidden' name='post' id='post' value = '" . $_POST["post"] . "'/>
                  <input type='hidden' name='reporter' id='reporter' value = '" . $_POST["reporter"] . "'/>
                  ";

                 ?>
                 <input type='submit' class='dropdown-item' style='color: red;background:lightgrey;' value = 'Report' />
              </form>
            </div>
          </div>
        </div>
